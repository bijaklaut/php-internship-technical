...
<div class="py-10 w-full max-w-[1024px] mx-auto px-10">
   ...
   <a class="bg-sky-500 px-5 py-2 rounded-md inline-block text-sm" href="/outlet/add" role="button">Add Outlet</a>
   <form action="<?= base_url("/outlet") ?>" method="GET">
      <div class="gap-2 flex my-2 items-center">
         <input name="search" type="text" class="py-1 px-3 min-w-[300px] rounded-md my-2 text-black" placeholder="Cari outlet">
         ...
         <tbody>
            ...
            <?php foreach ($outlets as $outlet) : ?>
               <tr class="[&>*]:p-3 [&>*]:text-center">
                  ...
                  <td><?= $outlet['pic'] ?></td>
                  <td>
                     <div class="w-[200px] h-full flex items-center justify-center gap-1">
